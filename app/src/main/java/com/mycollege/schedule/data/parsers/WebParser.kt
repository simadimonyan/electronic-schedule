...
class WebParser {
    ...
    companion object {
        ...
        fun loadData(progress: (Int) -> Unit): HashMap<String, HashMap<String, ArrayList<Group>>> {
            ...
            groups = sorted.toMutableMap() as HashMap<String, HashMap<String, ArrayList<Group>>>
